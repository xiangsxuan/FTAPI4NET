...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class InitConnect {
    ...
    static InitConnect() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "byJVCgNDMlMSEQoJY2xpZW50VmVyGAEgAigFEhAKCGNsaWVudElEGAIgAigJ", 
            "EhIKCnJlY3ZOb3RpZnkYAyABKAgSFQoNcGFja2V0RW5jQWxnbxgEIAEoBSJ+", 
            "CgNTMkMSEQoJc2VydmVyVmVyGAEgAigFEhMKC2xvZ2luVXNlcklEGAIgAigE", 
            "Eg4KBmNvbm5JRBgDIAIoBBISCgpjb25uQUVTS2V5GAQgAigJEhkKEWtlZXBB", 
            "bGl2ZUludGVydmFsGAUgAigFEhAKCGFlc0NCQ2l2GAYgASgJIigKB1JlcXVl", 
            "c3QSHQoDYzJzGAEgAigLMhAuSW5pdENvbm5lY3QuQzJTImEKCFJlc3BvbnNl", 
            "EhUKB3JldFR5cGUYASACKAU6BC00MDASDgoGcmV0TXNnGAIgASgJEg8KB2Vy", 
            "ckNvZGUYAyABKAUSHQoDczJjGAQgASgLMhAuSW5pdENvbm5lY3QuUzJDQhUK", 
      ...
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_InitConnect_C2S__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.InitConnect.C2S, global::Futu.OpenApi.Pb.InitConnect.C2S.Builder>(internal__static_InitConnect_C2S__Descriptor,
                new string[] { "ClientVer", "ClientID", "RecvNotify", "PacketEncAlgo", });
    ...
    public sealed partial class C2S : pb::GeneratedMessage<C2S, C2S.Builder> {
      ...
      private static readonly string[] _c2SFieldNames = new string[] { "clientID", "clientVer", "packetEncAlgo", "recvNotify" };
      private static readonly uint[] _c2SFieldTags = new uint[] { 18, 8, 32, 24 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasRecvNotify) {
          output.WriteBool(3, field_names[3], RecvNotify);
        }
        if (hasPacketEncAlgo) {
