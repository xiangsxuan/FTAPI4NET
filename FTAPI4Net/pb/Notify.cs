...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class Notify {
    ...
    static Notify() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "ZW50EhEKCWV2ZW50VHlwZRgBIAIoBRIMCgRkZXNjGAIgAigJIj0KDVByb2dy", 
            "YW1TdGF0dXMSLAoNcHJvZ3JhbVN0YXR1cxgBIAIoCzIVLkNvbW1vbi5Qcm9n", 
            "cmFtU3RhdHVzIjcKDUNvbm5lY3RTdGF0dXMSEgoKcW90TG9naW5lZBgBIAIo", 
            "CBISCgp0cmRMb2dpbmVkGAIgAigIIkYKCFFvdFJpZ2h0EhIKCmhrUW90Umln", 
            "aHQYBCACKAUSEgoKdXNRb3RSaWdodBgFIAIoBRISCgpjblFvdFJpZ2h0GAYg", 
            "AigFIhwKCEFQSUxldmVsEhAKCGFwaUxldmVsGAMgAigJItgBCgNTMkMSDAoE", 
            "dHlwZRgBIAIoBRIfCgVldmVudBgCIAEoCzIQLk5vdGlmeS5HdHdFdmVudBIs", 
            "Cg1wcm9ncmFtU3RhdHVzGAMgASgLMhUuTm90aWZ5LlByb2dyYW1TdGF0dXMS", 
            "LAoNY29ubmVjdFN0YXR1cxgEIAEoCzIVLk5vdGlmeS5Db25uZWN0U3RhdHVz", 
            "EiIKCHFvdFJpZ2h0GAUgASgLMhAuTm90aWZ5LlFvdFJpZ2h0EiIKCGFwaUxl", 
            "dmVsGAYgASgLMhAuTm90aWZ5LkFQSUxldmVsIlwKCFJlc3BvbnNlEhUKB3Jl", 
            "dFR5cGUYASACKAU6BC00MDASDgoGcmV0TXNnGAIgASgJEg8KB2VyckNvZGUY", 
            "AyABKAUSGAoDczJjGAQgASgLMgsuTm90aWZ5LlMyQyqlAQoKTm90aWZ5VHlw", 
            "ZRITCg9Ob3RpZnlUeXBlX05vbmUQABIXChNOb3RpZnlUeXBlX0d0d0V2ZW50", 
            "EAESHAoYTm90aWZ5VHlwZV9Qcm9ncmFtU3RhdHVzEAISGQoVTm90aWZ5VHlw", 
            "ZV9Db25uU3RhdHVzEAMSFwoTTm90aWZ5VHlwZV9Rb3RSaWdodBAEEhcKE05v", 
            "dGlmeVR5cGVfQVBJTGV2ZWwQBSqbBAoMR3R3RXZlbnRUeXBlEhUKEUd0d0V2", 
          ...
          "cGVfRW5hYmxlRGV2aWNlTG9jaxAPQhUKE2NvbS5mdXR1Lm9wZW5hcGkucGI="));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Notify_QotRight__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.Notify.QotRight, global::Futu.OpenApi.Pb.Notify.QotRight.Builder>(internal__static_Notify_QotRight__Descriptor,
                new string[] { "HkQotRight", "UsQotRight", "CnQotRight", });
    ...
    public sealed partial class QotRight : pb::GeneratedMessage<QotRight, QotRight.Builder> {
      ...
      private static readonly string[] _qotRightFieldNames = new string[] { "cnQotRight", "hkQotRight", "usQotRight" };
      private static readonly uint[] _qotRightFieldTags = new uint[] { 48, 32, 40 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasHkQotRight) {
          output.WriteInt32(4, field_names[1], HkQotRight);
        }
        if (hasUsQotRight) {
          output.WriteInt32(5, field_names[2], UsQotRight);
        }
        if (hasCnQotRight) {
