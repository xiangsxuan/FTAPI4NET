...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class GetUserInfo {
    ...
    static GetUserInfo() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "byITCgNDMlMSDAoEZmxhZxgCIAEoBSLLAQoDUzJDEhAKCG5pY2tOYW1lGAEg", 
            "ASgJEhEKCWF2YXRhclVybBgCIAEoCRIQCghhcGlMZXZlbBgDIAEoCRISCgpo", 
            "a1FvdFJpZ2h0GAQgASgFEhIKCnVzUW90UmlnaHQYBSABKAUSEgoKY25Rb3RS", 
            "aWdodBgGIAEoBRIdChVpc05lZWRBZ3JlZURpc2NsYWltZXIYByABKAgSDgoG", 
            "dXNlcklEGAggASgDEhIKCnVwZGF0ZVR5cGUYCSABKAUSDgoGd2ViS2V5GAog", 
            "ASgJIigKB1JlcXVlc3QSHQoDYzJzGAEgAigLMhAuR2V0VXNlckluZm8uQzJT", 
            "ImEKCFJlc3BvbnNlEhUKB3JldFR5cGUYASACKAU6BC00MDASDgoGcmV0TXNn", 
            "GAIgASgJEg8KB2VyckNvZGUYAyABKAUSHQoDczJjGAQgASgLMhAuR2V0VXNl", 
            "ckluZm8uUzJDKk4KClVwZGF0ZVR5cGUSEwoPVXBkYXRlVHlwZV9Ob25lEAAS", 
            "FQoRVXBkYXRlVHlwZV9BZHZpY2UQARIUChBVcGRhdGVUeXBlX0ZvcmNlEAIq", 
            "rgEKDVVzZXJJbmZvRmllbGQSFwoTVXNlckluZm9GaWVsZF9CYXNpYxABEhUK", 
            "EVVzZXJJbmZvRmllbGRfQVBJEAISGgoWVXNlckluZm9GaWVsZF9Rb3RSaWdo", 
            "dBAEEhwKGFVzZXJJbmZvRmllbGRfRGlzY2xhaW1lchAIEhgKFFVzZXJJbmZv", 
            "RmllbGRfVXBkYXRlEBASGQoUVXNlckluZm9GaWVsZF9XZWJLZXkQgBBCFQoT", 
          "Y29tLmZ1dHUub3BlbmFwaS5wYg=="));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_GetUserInfo_S2C__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.GetUserInfo.S2C, global::Futu.OpenApi.Pb.GetUserInfo.S2C.Builder>(internal__static_GetUserInfo_S2C__Descriptor,
                new string[] { "NickName", "AvatarUrl", "ApiLevel", "HkQotRight", "UsQotRight", "CnQotRight", "IsNeedAgreeDisclaimer", "UserID", "UpdateType", "WebKey", });
    ...
    public sealed partial class S2C : pb::GeneratedMessage<S2C, S2C.Builder> {
      ...
      private static readonly string[] _s2CFieldNames = new string[] { "apiLevel", "avatarUrl", "cnQotRight", "hkQotRight", "isNeedAgreeDisclaimer", "nickName", "updateType", "usQotRight", "userID", "webKey" };
      private static readonly uint[] _s2CFieldTags = new uint[] { 26, 18, 48, 32, 56, 10, 72, 40, 64, 82 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasNickName) {
          output.WriteString(1, field_names[5], NickName);
        }
        if (hasAvatarUrl) {
        ...
        if (hasIsNeedAgreeDisclaimer) {
          output.WriteBool(7, field_names[4], IsNeedAgreeDisclaimer);
        }
        if (hasUserID) {
          output.WriteInt64(8, field_names[8], UserID);
        }
        if (hasUpdateType) {
          output.WriteInt32(9, field_names[6], UpdateType);
        }
        if (hasWebKey) {
          output.WriteString(10, field_names[9], WebKey);
        }
        UnknownFields.WriteTo(output);
      }
