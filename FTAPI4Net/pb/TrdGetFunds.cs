...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class TrdGetFunds {
    ...
    static TrdGetFunds() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "b3RvGhBUcmRfQ29tbW9uLnByb3RvIkIKA0MyUxIlCgZoZWFkZXIYASACKAsy", 
            "FS5UcmRfQ29tbW9uLlRyZEhlYWRlchIUCgxyZWZyZXNoQ2FjaGUYAiABKAgi", 
            "TgoDUzJDEiUKBmhlYWRlchgBIAIoCzIVLlRyZF9Db21tb24uVHJkSGVhZGVy", 
            "EiAKBWZ1bmRzGAIgASgLMhEuVHJkX0NvbW1vbi5GdW5kcyIpCgdSZXF1ZXN0", 
            "Eh4KA2MycxgBIAIoCzIRLlRyZF9HZXRGdW5kcy5DMlMiYgoIUmVzcG9uc2US", 
            "FQoHcmV0VHlwZRgBIAIoBToELTQwMBIOCgZyZXRNc2cYAiABKAkSDwoHZXJy", 
            "Q29kZRgDIAEoBRIeCgNzMmMYBCABKAsyES5UcmRfR2V0RnVuZHMuUzJDQhUK", 
      ...
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Trd_GetFunds_C2S__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.TrdGetFunds.C2S, global::Futu.OpenApi.Pb.TrdGetFunds.C2S.Builder>(internal__static_Trd_GetFunds_C2S__Descriptor,
                new string[] { "Header", "RefreshCache", });
    ...
    public sealed partial class C2S : pb::GeneratedMessage<C2S, C2S.Builder> {
      ...
      private static readonly string[] _c2SFieldNames = new string[] { "header", "refreshCache" };
      private static readonly uint[] _c2SFieldTags = new uint[] { 10, 16 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasRefreshCache) {
          output.WriteBool(2, field_names[1], RefreshCache);
        }
